...
import { RemoteDeleteUser } from '@/application/usecases/remote-delete-user'
...
type SutTypes = {
  sut: RemoteDeleteUser
  userRepositoryStub: UserRepository
}

const makeSut = (): SutTypes => {
  const userRepositoryStub = makeUserRepository()
  const sut = new RemoteDeleteUser(userRepositoryStub)
  return {
    sut,
    userRepositoryStub
  }
...
describe('RemoteDeleteUser UseCase', () => {

...
import { RemoteUpdateUser } from '@/application/usecases/remote-update-user'
...
type SutTypes = {
  sut: RemoteUpdateUser
  userRepositoryStub: UserRepository
}

const makeSut = (): SutTypes => {
  const userRepositoryStub = makeUserRepository()
  const sut = new RemoteUpdateUser(userRepositoryStub)
  return {
    sut,
    userRepositoryStub
  }
...
describe('RemoteUpdateUser UseCase', () => {

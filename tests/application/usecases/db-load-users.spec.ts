...
const makeUserRepository = (): UserRepository => {
  class UserRepositoryStub implements UserRepository {
    ...
    async add(_params: AddUserParams): Promise<User> { return {} as User }
    async loadById(_id: string): Promise<User> { return {} as User }
    async update(_params: UpdateUserParams): Promise<User> { return {} as User }
...
const makeSut = (): SutTypes => {
  ...
  const sut = new DbLoadUsers(userRepositoryStub)
  return {
    sut,
    userRepositoryStub
  }
